                            ...
                            {currentComments
                              ...
                              .map((comment) => (
                                <div key={comment.clave_comentario}>
                                  ...
                                  {/* Reply input - shows right below this comment when replying */}
                                  {replyingToId === comment.clave_comentario && (
                                    <div className="ml-10 mt-2 flex items-center gap-2 bg-blue-50 p-2 rounded-lg border-l-2 border-blue-400">
                                      ...
                                      <div className="flex-1 relative">
                                        <Input
                                          placeholder={`Responder a ${comment.nombres}...`}
                                          value={commentText}
                                  ...
                                  {/* Nested replies - with clear visual hierarchy */}
                                  {currentComments
                                    .filter(reply => reply.fk_comentario_padre === comment.clave_comentario)
                                    .map((reply) => (
                                      <div key={reply.clave_comentario} className="ml-10 mt-2 pl-3 border-l-2 border-gray-200">
                                        <div className="flex space-x-2">
